library(limma)
library(parallel)
# design: first column is sample, second column is individual, third column is individualgroup, fourth column is cell type.
# only supports two cell types for now
# testtype 'paired', 'unpaired', 'custom'

#res <- RAISINfit(expr = matrix(rnorm(100*8),nrow=100,dimnames=list(paste0('gene_',1:100),paste0('cell_',1:8))),sample=rep(c('r1_ct1','r2_ct1','r1_ct2','r3_ct2'),each=2),testtype='paired',design = data.frame(sample=c('r1_ct1','r2_ct1','r1_ct2','r3_ct2'),individual=c('r1','r2','r1','r3'),feature=c('ct1','ct1','ct2','ct2')))

#res <- RAISINfit(expr = matrix(rnorm(100*8),nrow=100,dimnames=list(paste0('gene_',1:100),paste0('cell_',1:8))),sample=rep(c('r1','r2','r3','r4'),each=2),testtype='unpaired',design = data.frame(sample=c('r1','r2','r3','r4'),feature=c('g1','g1','g2','g2')))

#res <- RAISINfit(expr = matrix(rnorm(100*10),nrow=100,dimnames=list(paste0('gene_',1:100),paste0('cell_',1:10))),sample=rep(c('r1_ct1','r2_ct1','r1_ct2','r2_ct2','r3_ct2'),each=2),testtype='paired',design = data.frame(sample=c('r1_ct1','r2_ct1','r1_ct2','r2_ct2','r3_ct2'),individual=c('r1','r2','r1','r2','r3'),feature=c('ct1','ct1','ct2','ct2','ct2')))
